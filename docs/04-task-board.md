...
| T19 | M5 | MCP、规则、技能、记忆及插件分类适配 | T16 | 单一加载责任、不重复工具注册 | **进行中**（T19-A 已完成：`docs/validation/M5-capability-sources.md`、ADR 0304；T19-B host-tool RPC、T19-C 技能/记忆/插件用户路径待开始） |
