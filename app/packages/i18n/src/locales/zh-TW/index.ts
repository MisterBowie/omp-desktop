...
sklm: {
  ...
  scheduled: {
    ...
    time: "執行時間",
    weekday: "星期",
    localTimeHint: "依電腦本地時區執行。請保持 PI-Desktop 執行；錯過的任務不補跑。受限操作仍需授權。",
  ...
  panel: {
    ...
    subagentLoading: "正在載入子智慧體詳情…",
    subagentError: "無法載入子智慧體詳情。",
    subagentRetry: "重試",
    resize: "調整工作面板寬度",
    maximize: "放大",
    restore: "縮小",
  ...
  errors: {
    ...
    PLAN_GOAL_CURSOR_UNSUPPORTED:
      "Cursor 模型不支援 Plan 與 Goal 模式。請切換到 Agent 模式，或改選其他模型。",
    TURN_ABORTED: "已停止。",
