...
sklm: {
  ...
  scheduled: {
    ...
    time: "시간",
    weekday: "요일",
    localTimeHint: "컴퓨터의 현지 시간대를 사용합니다. 앱을 실행 상태로 유지하세요. 놓친 실행은 건너뛰며 제한된 작업은 승인이 필요합니다.",
  ...
  panel: {
    ...
    subagentLoading: "서브에이전트 세부 정보를 불러오는 중…",
    subagentError: "서브에이전트 세부 정보를 불러올 수 없습니다.",
    subagentRetry: "다시 시도",
    resize: "작업 패널 크기 조절",
