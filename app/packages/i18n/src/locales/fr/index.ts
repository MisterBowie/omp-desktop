...
sklm: {
  ...
  "panel": {
    ...
    "subagentLoading": "Chargement des détails du sous-agent…",
    "subagentError": "Impossible de charger les détails du sous-agent.",
    "subagentRetry": "Réessayer",
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
  ...
  "errors": {
    ...
    "PLAN_GOAL_CURSOR_UNSUPPORTED":
      "Les modes Plan et Goal ne sont pas disponibles avec les modèles Cursor. Passez en mode Agent ou choisissez un autre modèle.",
    "TURN_ABORTED": "Arrêté.",
